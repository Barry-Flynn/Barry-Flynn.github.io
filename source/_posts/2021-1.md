...
- 为什么选择了Hexo而没有选择其他的？
&emsp;&emsp;其他常用的博客框架还有 <a href="https://wordpress.org/">WordPress</a>，<a href="https://typecho.org/">Typecho</a>，<a href="https://ghost.org/">Ghost</a> 等，但这些往往都需要购置自己的服务器，而无法静态化地部署到 GitHub Pages 上。个人博客的话，用 Hexo 完全不需要去另外购买空间，不需要有虚拟主机或者云服务器，可以直接托管到 ithub、coding、gitee 等托管平台，免费提供的空间就完全足够了，毕竟一篇写完的文章大小都是kb级别的。
