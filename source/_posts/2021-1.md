...
## 二、安装 VS Code
&emsp;&emsp;在安装Git之前，我建议先安装<a href="https://code.visualstudio.com/"> VS Code </a>。因为安装 Git Bash 时，可以设置 VS Code 作为默认编辑器Visual Studio Code，简称 VS Code。目前最为强大易用的编辑器，轻量且快速。~~（宇宙第一编辑器哈哈哈）~~
